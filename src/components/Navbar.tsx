...
//   useEffect(() => {
//     const handleScroll = () => {
//       setScrolled(window.scrollY > 10); // adjust scroll threshold here
//     };
...
//       <h1 className="ml-15 font-bold text-2xl text-[#F4C753]">
//         Utsav <span className="text-white">G.</span>
//       </h1>
//         </a>

//       <nav className="hidden md:flex items-center gap-6 text-md">
//         <a href="#about" className="hover:text-[#F4C753] duration-300 text-white">
//           About Me
//         </a>
//         <a href="#skills" className="hover:text-[#F4C753] duration-300 text-white">
//           Skills
//         </a>
//         <a href="#contact" className="hover:text-[#F4C753] duration-300 text-white">
//           Contact
//         </a>
